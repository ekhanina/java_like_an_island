...
import ru.stqa.island.mantis.model.Issue;
import ru.stqa.island.mantis.model.Project;
...
public class SoapHelper {
    ...
    private MantisConnectPortType getMantisConnect() throws ServiceException, MalformedURLException {
        return new MantisConnectLocator()
                    .getMantisConnectPort(new URL("http://localhost/mantisbt-1.3.16/api/soap/mantisconnect.php"));
    }
